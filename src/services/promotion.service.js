...
export const getPromotions = async () => await (await promotionAPI.get("/")).data;
...
export const putPromotion = async (promotion) =>
  await (await promotionAPI.put(`${promotion.id}`, promotion)).data;

export const deletePromotion = async (id) =>
  await (await promotionAPI.delete(`/${id}`)).data;
